...
using CostsSettler.Repository.Interfaces;
using Microsoft.EntityFrameworkCore;

namespace CostsSettler.Repository.Repositories
{
    public class DataRepository : IDataRepository
    {
        private readonly CostsSettlerDbContext _dbContext;

        public DataRepository(CostsSettlerDbContext dbContext)
        {
